...
Framework của Microsoft cho AI orchestration, planner, plugins, memory và connectors.

## Kiến thức cốt lõi

- AI tool giúp tăng tốc nhưng code vẫn phải review, test và hiểu được.
- Khi tích hợp LLM vào app, cần kiểm soát dữ liệu nhạy cảm, prompt injection, latency và cost.
- RAG cần retrieval tốt, metadata, evaluation và fallback khi không đủ context.
...
- `Semantic Kernel ASP.NET Core`
- `Semantic Kernel .NET official documentation`
- `Semantic Kernel production best practices`
- `Semantic Kernel testing .NET`
