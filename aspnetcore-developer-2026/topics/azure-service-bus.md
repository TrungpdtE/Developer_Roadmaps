...
Managed message broker của Azure, phù hợp enterprise/cloud app.
...
- `Azure Service Bus ASP.NET Core`
- `Azure Service Bus .NET official documentation`
- `Azure Service Bus production best practices`
- `Azure Service Bus testing .NET`
