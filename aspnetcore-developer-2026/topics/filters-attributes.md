...
Cơ chế chạy logic quanh action/controller: auth, validation, exception, logging.
...
- `Filters & Attributes ASP.NET Core`
- `Filters & Attributes .NET official documentation`
- `Filters & Attributes production best practices`
- `Filters & Attributes testing .NET`
