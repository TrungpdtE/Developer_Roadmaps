...
Biết dùng AI/LLM trong workflow dev và trong sản phẩm: prompt, RAG, tools, guardrails, privacy.
...
- `AI / LLMs ASP.NET Core`
- `AI / LLMs .NET official documentation`
- `AI / LLMs production best practices`
- `AI / LLMs testing .NET`
