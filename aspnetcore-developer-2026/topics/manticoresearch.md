...
Search engine fork/tiếp nối Sphinx, dùng cho full-text search hiệu năng cao.

## Kiến thức cốt lõi

- Search engine là read model/index, không nên là source of truth chính.
- Cần pipeline sync dữ liệu từ database sang index.
- Ranking, analyzer, tokenizer và mapping quyết định chất lượng search.
...
- `ManticoreSearch ASP.NET Core`
- `ManticoreSearch .NET official documentation`
- `ManticoreSearch production best practices`
- `ManticoreSearch testing .NET`
