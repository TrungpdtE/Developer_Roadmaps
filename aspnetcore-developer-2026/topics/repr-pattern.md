...
Request-Endpoint-Response pattern giúp endpoint rõ trách nhiệm.
...
- `REPR Pattern ASP.NET Core`
- `REPR Pattern .NET official documentation`
- `REPR Pattern production best practices`
- `REPR Pattern testing .NET`
