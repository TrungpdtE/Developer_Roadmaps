...
Elasticsearch, Logstash, Kibana cho ingest/search/visualize log.
...
- `ELK Stack .NET official documentation`
- `ELK Stack production best practices`
- `ELK Stack testing .NET`
