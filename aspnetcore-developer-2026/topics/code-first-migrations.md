...
Thiết kế model C# rồi sinh migration để version schema database.
...
- `Code First + Migrations ASP.NET Core`
- `Code First + Migrations .NET official documentation`
- `Code First + Migrations production best practices`
- `Code First + Migrations testing .NET`
