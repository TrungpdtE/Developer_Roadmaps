...
Tự động build, test, scan, package, deploy để giảm lỗi release.

## Kiến thức cốt lõi

- CI phải chạy restore, build, test và optional static analysis/security scan.
- CD cần environment config, migration strategy, rollback và approval khi cần.
- Pipeline phải reproducible; tránh bước thủ công không ghi lại.
...
- `Continuous Integration & Delivery (Automation) ASP.NET Core`
- `Continuous Integration & Delivery (Automation) .NET official documentation`
- `Continuous Integration & Delivery (Automation) production best practices`
- `Continuous Integration & Delivery (Automation) testing .NET`
