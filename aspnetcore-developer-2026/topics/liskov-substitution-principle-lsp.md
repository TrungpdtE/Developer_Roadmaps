...
Subtype phải thay thế được base type mà không phá contract.
...
- `Liskov Substitution Principle (LSP) ASP.NET Core`
- `Liskov Substitution Principle (LSP) .NET official documentation`
- `Liskov Substitution Principle (LSP) production best practices`
- `Liskov Substitution Principle (LSP) testing .NET`
