...
Object-relational mapping giúp map C# entity với database table nhưng vẫn cần hiểu SQL.

## Kiến thức cốt lõi

- ORM map object sang table nhưng query vẫn chạy trên database thật.
- Cần hiểu transaction, lazy loading, eager loading, N+1, concurrency token.
- Không expose entity trực tiếp ra API response nếu có field nhạy cảm/navigation phức tạp.
...
- `ORM ASP.NET Core`
- `ORM .NET official documentation`
- `ORM production best practices`
- `ORM testing .NET`
