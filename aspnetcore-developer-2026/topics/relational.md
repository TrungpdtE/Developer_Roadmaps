...
Database quan hệ dùng SQL, transaction, constraint, index, JOIN.
...
- `Relational ASP.NET Core`
- `Relational .NET official documentation`
- `Relational production best practices`
- `Relational testing .NET`
