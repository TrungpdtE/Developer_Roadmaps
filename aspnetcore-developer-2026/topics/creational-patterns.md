...
Factory, Builder, Singleton, Prototype: nhóm pattern tạo object.
...
- `Creational Patterns ASP.NET Core`
- `Creational Patterns .NET official documentation`
- `Creational Patterns production best practices`
- `Creational Patterns testing .NET`
