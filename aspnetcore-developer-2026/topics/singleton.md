...
Một instance cho toàn app, phải thread-safe và không phụ thuộc scoped service trực tiếp.
...
- `Singleton ASP.NET Core`
- `Singleton .NET official documentation`
- `Singleton production best practices`
- `Singleton testing .NET`
