...
Serverless key-value/document database của AWS, thiết kế theo access pattern.
...
- `Amazon DynamoDB ASP.NET Core`
- `Amazon DynamoDB .NET official documentation`
- `Amazon DynamoDB production best practices`
- `Amazon DynamoDB testing .NET`
