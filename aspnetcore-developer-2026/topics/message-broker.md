...
Broker truyền message/event bất đồng bộ giữa service.
...
- `Message-Broker ASP.NET Core`
- `Message-Broker .NET official documentation`
- `Message-Broker production best practices`
- `Message-Broker testing .NET`
