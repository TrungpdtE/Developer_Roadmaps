...
Adapter, Decorator, Facade, Proxy, Composite: nhóm pattern cấu trúc object.
...
- `Structural Patterns ASP.NET Core`
- `Structural Patterns .NET official documentation`
- `Structural Patterns production best practices`
- `Structural Patterns testing .NET`
