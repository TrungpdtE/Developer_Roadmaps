...
Gateway gom routing, auth, rate limit, aggregation, versioning cho microservices.

## Kiến thức cốt lõi

- API gateway xử lý cross-cutting concerns ở rìa hệ thống.
- Không nhét business logic phức tạp vào gateway.
- Gateway cần rate limit, auth, routing, timeout và observability.
...
- `API Gateway .NET official documentation`
- `API Gateway production best practices`
- `API Gateway testing .NET`
