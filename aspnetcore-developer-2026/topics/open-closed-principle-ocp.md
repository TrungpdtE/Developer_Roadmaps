...
Mở rộng hành vi bằng abstraction/composition thay vì sửa code cũ liên tục.
...
- `Open-Closed Principle (OCP) ASP.NET Core`
- `Open-Closed Principle (OCP) .NET official documentation`
- `Open-Closed Principle (OCP) production best practices`
- `Open-Closed Principle (OCP) testing .NET`
