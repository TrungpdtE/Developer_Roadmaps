...
Kỹ thuật đưa dependency từ ngoài vào, nền tảng của ASP.NET Core service container.
...
- `Dependency Injection .NET official documentation`
- `Dependency Injection production best practices`
- `Dependency Injection testing .NET`
