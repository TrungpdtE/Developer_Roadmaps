...
Tự tạo object graph cho unit test, giảm setup dài.
...
- `AutoFixture ASP.NET Core`
- `AutoFixture .NET official documentation`
- `AutoFixture production best practices`
- `AutoFixture testing .NET`
