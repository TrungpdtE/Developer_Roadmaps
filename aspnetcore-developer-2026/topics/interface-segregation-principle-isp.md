...
Interface nên nhỏ và theo nhu cầu client, tránh ép class implement thứ không dùng.
...
- `Interface Segregation Principle (ISP) ASP.NET Core`
- `Interface Segregation Principle (ISP) .NET official documentation`
- `Interface Segregation Principle (ISP) production best practices`
- `Interface Segregation Principle (ISP) testing .NET`
