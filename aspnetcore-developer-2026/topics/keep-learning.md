...
Roadmap không kết thúc; bạn cần liên tục đọc release notes, docs, source code và làm project thật.
...
- `Keep Learning ASP.NET Core`
- `Keep Learning .NET official documentation`
- `Keep Learning production best practices`
- `Keep Learning testing .NET`
