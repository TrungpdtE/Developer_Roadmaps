...
RPC hiệu năng cao dùng HTTP/2 + Protobuf, phù hợp internal service-to-service.

## Kiến thức cốt lõi

- gRPC dùng schema `.proto`, Protobuf binary và HTTP/2.
- Phù hợp internal service-to-service cần contract type-safe và performance.
- Versioning schema phải backward compatible.
...
- `gRPC ASP.NET Core`
- `gRPC .NET official documentation`
