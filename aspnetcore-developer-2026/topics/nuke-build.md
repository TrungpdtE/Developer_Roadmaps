...
Build automation bằng C# thay vì YAML/script rời rạc.
...
- `Nuke Build ASP.NET Core`
- `Nuke Build .NET official documentation`
- `Nuke Build production best practices`
- `Nuke Build testing .NET`
