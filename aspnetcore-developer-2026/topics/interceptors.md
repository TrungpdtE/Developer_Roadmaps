...
Hook vào query/command/SaveChanges để audit, logging, multi-tenancy hoặc policy.
...
- `Interceptors ASP.NET Core`
- `Interceptors .NET official documentation`
- `Interceptors production best practices`
- `Interceptors testing .NET`
