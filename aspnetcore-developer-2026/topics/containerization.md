...
Đóng gói app và dependency runtime thành image chạy nhất quán.

## Kiến thức cốt lõi

- Container image phải nhỏ, reproducible và không chứa secrets.
- Expose port đúng, health check rõ, config qua environment.
- Multi-stage build giúp image runtime nhẹ hơn.
...
- `Containerization ASP.NET Core`
- `Containerization .NET official documentation`
- `Containerization production best practices`
- `Containerization testing .NET`
