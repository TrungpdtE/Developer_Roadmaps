...
Chuẩn instrumentation metrics/logs/traces vendor-neutral.
...
- `OpenTelemetry (OTel) ASP.NET Core`
- `OpenTelemetry (OTel) .NET official documentation`
- `OpenTelemetry (OTel) production best practices`
- `OpenTelemetry (OTel) testing .NET`
