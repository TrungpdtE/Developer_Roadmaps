...
Hai cách xây HTTP API phổ biến: MVC Controller đầy đủ và Minimal API gọn nhẹ.
...
- `MVC & Minimal APIs ASP.NET Core`
- `MVC & Minimal APIs .NET official documentation`
- `MVC & Minimal APIs production best practices`
- `MVC & Minimal APIs testing .NET`
