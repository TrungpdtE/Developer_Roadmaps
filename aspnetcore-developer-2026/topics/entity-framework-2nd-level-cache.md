...
Cache query result EF Core ở tầng thứ hai, cần invalidation cẩn thận.
...
- `Entity Framework 2nd Level Cache ASP.NET Core`
- `Entity Framework 2nd Level Cache .NET official documentation`
- `Entity Framework 2nd Level Cache production best practices`
- `Entity Framework 2nd Level Cache testing .NET`
