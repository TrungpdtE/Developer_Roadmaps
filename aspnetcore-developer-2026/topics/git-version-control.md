...
Version control với Git, GitHub/GitLab: commit, branch, merge, rebase, pull request và conflict.

## Kiến thức cốt lõi

- Commit nhỏ, message rõ, branch theo feature/fix.
- Pull request là nơi review behavior, tests, security và maintainability.
- Conflict phải đọc domain logic, không chọn bừa một bên.
...
```bash
git status
git switch -c feature/student-enrollment
git add .
git commit -m "Add student enrollment API"
...
- `GIT - Version Control ASP.NET Core`
- `GIT - Version Control .NET official documentation`
- `GIT - Version Control production best practices`
- `GIT - Version Control testing .NET`
