...
Một class/module nên có một lý do chính để thay đổi.
...
- `Single Responsibility Principle (SRP) ASP.NET Core`
- `Single Responsibility Principle (SRP) .NET official documentation`
- `Single Responsibility Principle (SRP) production best practices`
- `Single Responsibility Principle (SRP) testing .NET`
