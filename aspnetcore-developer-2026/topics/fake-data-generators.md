...
Sinh dữ liệu test hợp lệ/ngẫu nhiên để giảm boilerplate.
...
- `Fake Data Generators ASP.NET Core`
- `Fake Data Generators .NET official documentation`
- `Fake Data Generators production best practices`
- `Fake Data Generators testing .NET`
