...
Abstraction/event bus giúp publish/consume message trong distributed app.
...
- `Message-Bus ASP.NET Core`
- `Message-Bus .NET official documentation`
- `Message-Bus production best practices`
- `Message-Bus testing .NET`
