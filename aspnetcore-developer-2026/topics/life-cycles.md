...
Service lifetime quyết định object sống bao lâu: singleton, scoped, transient.
...
- `Life Cycles ASP.NET Core`
- `Life Cycles .NET official documentation`
- `Life Cycles production best practices`
- `Life Cycles testing .NET`
