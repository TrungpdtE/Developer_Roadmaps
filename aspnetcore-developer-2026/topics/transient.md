...
Tạo instance mới mỗi lần resolve, phù hợp service nhẹ không giữ state.
...
- `Transient ASP.NET Core`
- `Transient .NET official documentation`
- `Transient production best practices`
- `Transient testing .NET`
