...
AMQP broker phổ biến, mạnh về queue/routing/retry/DLQ.
...
- `RabbitMQ ASP.NET Core`
- `RabbitMQ .NET official documentation`
- `RabbitMQ production best practices`
- `RabbitMQ testing .NET`
