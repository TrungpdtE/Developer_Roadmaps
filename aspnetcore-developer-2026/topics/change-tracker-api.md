...
EF Core theo dõi entity state để biết insert/update/delete khi SaveChanges.
...
- `Change Tracker API ASP.NET Core`
- `Change Tracker API .NET official documentation`
- `Change Tracker API production best practices`
- `Change Tracker API testing .NET`
