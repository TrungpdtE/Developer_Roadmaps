...
GraphQL server phổ biến trong .NET.

## Kiến thức cốt lõi

- GraphQL cho client chọn field, giảm over/under-fetching.
- Cần kiểm soát query complexity, depth, authorization từng field và N+1.
- DataLoader rất quan trọng để tránh N+1 khi resolve nested fields.
...
public sealed class Query
{
    ...
    {
        return new StudentDto(studentCode, "Nguyen Van An");
    }
}
```
...
- `HotChocolate .NET official documentation`
- `HotChocolate production best practices`
- `HotChocolate testing .NET`
