...
Một instance cho mỗi scope/request, rất thường dùng cho DbContext/service request-bound.
...
- `Scoped ASP.NET Core`
- `Scoped .NET official documentation`
- `Scoped production best practices`
- `Scoped testing .NET`
