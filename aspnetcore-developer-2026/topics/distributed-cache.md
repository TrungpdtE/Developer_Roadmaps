...
Cache dùng chung giữa nhiều instance app.
...
- `Distributed Cache ASP.NET Core`
- `Distributed Cache .NET official documentation`
- `Distributed Cache production best practices`
- `Distributed Cache testing .NET`
