...
Chạy dependency thật bằng container trong integration test.
...
- `Test Containers ASP.NET Core`
- `Test Containers .NET official documentation`
- `Test Containers production best practices`
- `Test Containers testing .NET`
