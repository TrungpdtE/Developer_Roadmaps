...
Actor model framework đa ngôn ngữ, có .NET support.
...
- `Proto.Actor ASP.NET Core`
- `Proto.Actor .NET official documentation`
- `Proto.Actor production best practices`
- `Proto.Actor testing .NET`
