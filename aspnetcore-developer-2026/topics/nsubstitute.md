...
Mocking library cú pháp tự nhiên, dễ đọc.
...
- `NSubstitute ASP.NET Core`
- `NSubstitute .NET official documentation`
- `NSubstitute production best practices`
- `NSubstitute testing .NET`
