...
Event streaming platform cho event log, stream processing và data pipeline.
...
- `Apache Kafka .NET official documentation`
- `Apache Kafka production best practices`
- `Apache Kafka testing .NET`
