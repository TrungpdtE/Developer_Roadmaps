...
DI container mặc định trong ASP.NET Core, đủ cho đa số ứng dụng.

## Kiến thức cốt lõi

- Constructor injection làm dependency rõ ràng và test dễ.
- Lifetime sai là nguồn bug phổ biến: singleton giữ scoped service, DbContext dùng sai scope.
- Không lạm dụng service locator `IServiceProvider` trong business service.

## Facts cần nhớ

- Mức trong roadmap: **Must know**. Bắt buộc học nếu mục tiêu là đi ASP.NET Core backend nghiêm túc.
- Nhóm học: **Dependency Injection**.
...
public sealed class EnrollmentService
{
    ...
    public EnrollmentService(IEmailTemplateRenderer renderer)
    {
...
- `Microsoft.Extensions.DependencyInjection .NET official documentation`
- `Microsoft.Extensions.DependencyInjection production best practices`
- `Microsoft.Extensions.DependencyInjection testing .NET`
