...
Protocol query API mạnh, phù hợp enterprise/data-heavy API nhưng cần kiểm soát complexity.
...
- `OData ASP.NET Core`
- `OData .NET official documentation`
- `OData production best practices`
- `OData testing .NET`
