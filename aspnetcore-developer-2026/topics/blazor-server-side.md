...
Blazor chạy server, UI cập nhật qua SignalR.
...
- `Blazor Server-Side ASP.NET Core`
- `Blazor Server-Side .NET official documentation`
- `Blazor Server-Side production best practices`
- `Blazor Server-Side testing .NET`
