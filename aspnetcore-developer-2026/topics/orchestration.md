...
Điều phối container/service nhiều node: scheduling, scaling, rolling update.

## Kiến thức cốt lõi

- Orchestration quản lý deploy, scale, rollout, service discovery và health.
- Kubernetes mạnh nhưng phức tạp; không cần cho mọi project nhỏ.
- Manifest/Helm/Kustomize phải version-controlled.
...
- `Orchestration ASP.NET Core`
- `Orchestration .NET official documentation`
- `Orchestration production best practices`
- `Orchestration testing .NET`
