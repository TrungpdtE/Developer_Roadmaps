...
ORM chính của Microsoft cho .NET: DbContext, DbSet, LINQ, tracking, migrations.
...
- `Entity Framework Core .NET official documentation`
- `Entity Framework Core production best practices`
- `Entity Framework Core testing .NET`
