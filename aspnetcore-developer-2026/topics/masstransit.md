...
Service bus library phổ biến trong .NET, hỗ trợ RabbitMQ/Azure Service Bus/Kafka.
...
- `MassTransit ASP.NET Core`
- `MassTransit .NET official documentation`
- `MassTransit production best practices`
- `MassTransit testing .NET`
