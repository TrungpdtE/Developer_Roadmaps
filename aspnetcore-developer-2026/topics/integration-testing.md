...
Test nhiều layer thật hơn: API + DI + database + message broker.
...
- `Integration Testing .NET official documentation`
- `Integration Testing production best practices`
- `Integration Testing testing .NET`
