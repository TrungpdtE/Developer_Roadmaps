...
NoSQL key-value/document database serverless của AWS, thiết kế theo access pattern.
...
- `Amazon DynamoDB Java official documentation`
- `Amazon DynamoDB best practices Java`
- `Amazon DynamoDB production pitfalls`
- `Amazon DynamoDB Spring Boot integration`
