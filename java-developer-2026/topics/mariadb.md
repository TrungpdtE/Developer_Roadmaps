...
Fork/alternative của MySQL, tương thích nhiều use case MySQL.
...
- `MariaDB Java official documentation`
- `MariaDB best practices Java`
- `MariaDB production pitfalls`
- `MariaDB Spring Boot integration`
