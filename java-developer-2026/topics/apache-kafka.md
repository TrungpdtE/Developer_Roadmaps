...
Distributed event streaming platform cho event log, stream processing, data pipelines.
...
- `Apache Kafka Java official documentation`
- `Apache Kafka best practices Java`
- `Apache Kafka production pitfalls`
