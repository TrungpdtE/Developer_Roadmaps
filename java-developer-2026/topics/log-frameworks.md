...
Biết facade/implementation, log level, structured logging và correlation id.
...
- `Log Frameworks Java official documentation`
- `Log Frameworks best practices Java`
- `Log Frameworks production pitfalls`
- `Log Frameworks Spring Boot integration`
