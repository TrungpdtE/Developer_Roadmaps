...
Chạy database/broker thật trong container cho integration test đáng tin hơn.
...
- `Testcontainers Java official documentation`
- `Testcontainers best practices Java`
- `Testcontainers production pitfalls`
