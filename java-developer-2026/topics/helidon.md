...
> Nhóm: Web Frameworks + Routers  
> Mức ưu tiên: Personal must know

## Học để làm gì?

Framework microservice Java của Oracle, có SE/MP, phù hợp cloud-native service.
...
- Nhóm học: **Web Frameworks + Routers**.
...
- `Helidon Java official documentation`
- `Helidon best practices Java`
- `Helidon production pitfalls`
- `Helidon Spring Boot integration`
