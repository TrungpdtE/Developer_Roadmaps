...
Kiến trúc API phổ biến nhất: resource, method HTTP, status code, JSON, idempotency.
...
- `REST Java official documentation`
- `REST best practices Java`
- `REST production pitfalls`
