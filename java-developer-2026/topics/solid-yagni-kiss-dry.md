...
Nguyên tắc thiết kế giúp code dễ hiểu, dễ sửa, không over-engineer.

## Kiến thức cốt lõi

- KISS: giữ giải pháp đơn giản trước khi thêm abstraction.
- YAGNI: đừng xây thứ chưa có nhu cầu thật.
- DRY: tránh lặp logic quan trọng, nhưng đừng gom code chỉ vì giống hình thức.
...
public class DiscountCalculator {
    public int calculateDiscountPercent(Customer customer) {
...
record Customer(boolean isStudent, boolean isSenior) {
}
```
...
- `SOLID, YAGNI, KISS, DRY Java official documentation`
- `SOLID, YAGNI, KISS, DRY best practices Java`
- `SOLID, YAGNI, KISS, DRY production pitfalls`
- `SOLID, YAGNI, KISS, DRY Spring Boot integration`
