...
Interface là contract để code phụ thuộc vào hành vi thay vì phụ thuộc implementation cụ thể.
...
- `Interface Java official documentation`
- `Interface best practices Java`
- `Interface production pitfalls`
- `Interface Spring Boot integration`
