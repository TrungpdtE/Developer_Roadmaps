...
Remote Procedure Call: gọi method/service từ xa qua protocol chặt chẽ hơn REST trong nhiều hệ internal.

## Kiến thức cốt lõi

- RPC phù hợp service nội bộ cần contract chặt, hiệu năng tốt và type-safety.
- Schema là contract; thay đổi schema cần backward compatibility.
- REST vẫn tốt cho public API; RPC thường tốt cho internal service-to-service.
...
- `RPC Java official documentation`
- `RPC best practices Java`
- `RPC production pitfalls`
- `RPC Spring Boot integration`
