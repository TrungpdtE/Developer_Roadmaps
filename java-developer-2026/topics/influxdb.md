...
Time-series database cho metrics, sensor data, monitoring.
...
- `InfluxDB Java official documentation`
- `InfluxDB best practices Java`
- `InfluxDB production pitfalls`
- `InfluxDB Spring Boot integration`
