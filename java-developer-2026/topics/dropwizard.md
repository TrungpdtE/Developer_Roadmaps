...
Framework service Java opinionated, tích hợp Jetty, Jersey, Jackson, metrics.
...
- `dropwizard Java official documentation`
- `dropwizard best practices Java`
- `dropwizard production pitfalls`
