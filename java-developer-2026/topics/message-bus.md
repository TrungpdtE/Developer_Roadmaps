...
Bus nội bộ để publish/subscribe event trong app hoặc giữa module/service.
...
- `Message-Bus Java official documentation`
- `Message-Bus best practices Java`
- `Message-Bus production pitfalls`
- `Message-Bus Spring Boot integration`
