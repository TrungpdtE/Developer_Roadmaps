...
Test đơn vị nhỏ, nhanh, độc lập; thường dùng JUnit + AssertJ + Mockito.
...
- `Unit Testing Java official documentation`
- `Unit Testing best practices Java`
- `Unit Testing production pitfalls`
- `Unit Testing Spring Boot integration`
