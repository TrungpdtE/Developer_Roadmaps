...
Nhóm pattern tạo object: Factory, Builder, Singleton, Prototype.
...
- `Creational Java official documentation`
- `Creational best practices Java`
- `Creational production pitfalls`
- `Creational Spring Boot integration`
