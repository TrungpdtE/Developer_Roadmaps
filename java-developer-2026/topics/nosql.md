...
Nhóm database không thuần quan hệ: document, key-value, wide-column, time-series, graph/vector.
...
- `NoSQL Java official documentation`
- `NoSQL best practices Java`
- `NoSQL production pitfalls`
- `NoSQL Spring Boot integration`
