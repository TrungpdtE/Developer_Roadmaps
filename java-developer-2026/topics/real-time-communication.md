...
Giao tiếp realtime bằng WebSocket, SSE, long polling hoặc event streaming.

## Kiến thức cốt lõi

- Realtime thường dùng WebSocket, Server-Sent Events hoặc long polling.
- Cần heartbeat, reconnect, authentication và backpressure.
- Không dùng realtime nếu polling đơn giản đã đủ cho nghiệp vụ.
...
- `Real-Time Communication Java official documentation`
- `Real-Time Communication best practices Java`
- `Real-Time Communication production pitfalls`
- `Real-Time Communication Spring Boot integration`
