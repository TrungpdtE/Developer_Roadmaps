...
Thay dependency bằng mock/fake/stub để test class đang xét trong isolation.
...
- `Mocking Java official documentation`
- `Mocking best practices Java`
- `Mocking production pitfalls`
- `Mocking Spring Boot integration`
