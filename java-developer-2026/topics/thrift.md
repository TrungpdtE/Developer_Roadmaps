...
RPC/serialization framework của Apache, gặp trong một số hệ phân tán.
...
- `thrift Java official documentation`
- `thrift best practices Java`
- `thrift production pitfalls`
- `thrift Spring Boot integration`
