...
Message broker AMQP phổ biến, mạnh về queue/routing patterns.
...
- `RabbitMQ Java official documentation`
- `RabbitMQ best practices Java`
- `RabbitMQ production pitfalls`
