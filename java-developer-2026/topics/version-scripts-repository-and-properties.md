# Version, Scripts, Repository and Properties
...
Cấu hình version Java, scripts build, repository Maven, properties và profile trong build tool.

## Kiến thức cốt lõi

- Build tool giúp dự án chạy giống nhau trên máy bạn, máy bạn bè và CI.
- Dependency có version, scope/configuration và transitive dependency.
- Không commit artifact build như `target/` hoặc `build/`.
...
<project>
    ...
    <groupId>dev.roadmap</groupId>
    <artifactId>java-developer-2026-demo</artifactId>
...
- `Version, Scripts, Repository and Properties Java official documentation`
- `Version, Scripts, Repository and Properties best practices Java`
- `Version, Scripts, Repository and Properties production pitfalls`
- `Version, Scripts, Repository and Properties Spring Boot integration`
