...
API query language cho phép client chọn field cần lấy, khác REST endpoint cố định.
...
- `GraphQL Java official documentation`
- `GraphQL best practices Java`
- `GraphQL production pitfalls`
