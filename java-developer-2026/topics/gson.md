...
JSON serialization/deserialization library của Google; hiện nhiều Spring app mặc định dùng Jackson.
...
- `gson Java official documentation`
- `gson best practices Java`
- `gson production pitfalls`
- `gson Spring Boot integration`
