...
Document database phổ biến, lưu JSON-like document, linh hoạt schema.
...
- `MongoDB Java official documentation`
- `MongoDB best practices Java`
- `MongoDB production pitfalls`
