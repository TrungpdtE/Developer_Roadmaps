...
Document database có replication/sync model, dùng trong một số hệ offline-first.
...
- `CouchDB Java official documentation`
- `CouchDB best practices Java`
- `CouchDB production pitfalls`
- `CouchDB Spring Boot integration`
