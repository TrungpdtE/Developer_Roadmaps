...
Biết build project, khai báo dependency, chạy test, đóng gói artifact và quản lý thư viện.
...
- `Gradle/Maven, Library Java official documentation`
- `Gradle/Maven, Library best practices Java`
- `Gradle/Maven, Library production pitfalls`
- `Gradle/Maven, Library Spring Boot integration`
