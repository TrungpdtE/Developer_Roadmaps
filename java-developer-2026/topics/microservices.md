...
Kiến trúc chia hệ thống thành service nhỏ, deploy độc lập, giao tiếp qua API/event.
...
- `MicroServices Java official documentation`
- `MicroServices best practices Java`
- `MicroServices production pitfalls`
- `MicroServices Spring Boot integration`
