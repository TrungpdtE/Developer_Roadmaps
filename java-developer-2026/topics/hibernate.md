...
ORM phổ biến nhất trong Java, triển khai JPA và xử lý entity, persistence context, lazy loading.

## Kiến thức cốt lõi

- ORM map object sang table nhưng không thay thế hiểu biết SQL.
- Cần hiểu entity lifecycle, transaction, lazy loading và N+1 query.
- Không expose entity trực tiếp ra API nếu entity chứa quan hệ phức tạp hoặc field nhạy cảm.
...
- `Hibernate Java official documentation`
- `Hibernate best practices Java`
- `Hibernate production pitfalls`
