...
Apache Shiro là security framework cho authentication/authorization/session.
...
- `shiro Java official documentation`
- `shiro best practices Java`
- `shiro production pitfalls`
