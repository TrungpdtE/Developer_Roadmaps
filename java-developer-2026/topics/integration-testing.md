...
Test nhiều layer/dependency phối hợp, ví dụ API + database + message broker.
...
- `Integration Testing Java official documentation`
- `Integration Testing best practices Java`
- `Integration Testing production pitfalls`
- `Integration Testing Spring Boot integration`
