...
Integration testing framework cho messaging, HTTP, SOAP, Kafka và enterprise integration.
...
- `Citrus Framework Java official documentation`
- `Citrus Framework best practices Java`
- `Citrus Framework production pitfalls`
- `Citrus Framework Spring Boot integration`
