...
Mock HTTP server để test service gọi API ngoài mà không phụ thuộc mạng thật.
...
- `wiremock Java official documentation`
- `wiremock best practices Java`
- `wiremock production pitfalls`
